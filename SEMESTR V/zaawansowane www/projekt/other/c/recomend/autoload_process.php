...
if($_POST)
{
	...
	@$year = date(Y)-5;
	$zap = "SELECT * FROM `movie` WHERE `premier` >= '$year-".date('m-d')."' AND rating <= 7 AND rating >= 6 AND type NOT LIKE '%Dokumenta%' ORDER BY `rating` DESC LIMIT $position, $items_per_group";
