...
def get_options(options):
    ...
    parser.add_argument('-l', action='store_true', dest='lines',        help="zlicz linie")
    parser.add_argument('-w', action='store_true', dest='words',        help="zlicz slowa")
    parser.add_argument('-c', action='store_true', dest='characters',   help="zlicz znaki")
    parser.add_argument('-i', action='store_true', dest='integers',     help="zlicz liczby calkowite")
    parser.add_argument('-d', action='store_true', dest='numbers',      help="zlicz cyfry")
    parser.add_argument('-e', action='store_true', dest='show_hash',    help="pokazuj linie z #")
    parser.add_argument('file', action='store', nargs='+', help='pliki do sprawdzenia')
